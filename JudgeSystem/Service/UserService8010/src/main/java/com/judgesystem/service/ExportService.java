...
public class ExportService {
    public static ResponseEntity<byte[]> user2Excel(List<User> list) {
        ...
        //文档类别
        docInfo.setCategory("职工信息");
        //文档管理员
        docInfo.setManager("admin");
        //设置公司信息
        docInfo.setCompany("www.swu.edu.cn");
        //4. 获取文档摘要信息
        SummaryInformation summInfo = workbook.getSummaryInformation();
        //文档标题
        summInfo.setTitle("职工信息表");
        //文档作者
        summInfo.setAuthor("admin");
        // 文档备注
        summInfo.setComments("本文档由 admin 提供");
        //5. 创建样式
        //创建标题行的样式
        ...
        HSSFSheet sheet = workbook.createSheet("职工信息表");
        //设置列的宽度
       ...
       /*  HSSFCell c12 = r0.createCell(12);
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            row.createCell(3).setCellValue(user.getPostId());
            ...
            cell6.setCellValue(user.getBirthday());

            row.createCell(7).setCellValue(user.getNation());
            row.createCell(8).setCellValue(user.getNativePlace());
            row.createCell(9).setCellValue(user.getEmail());
            row.createCell(10).setCellValue(user.getDepartment());
            row.createCell(11).setCellValue(user.getPosition());
        ...
        try {
            headers.setContentDispositionFormData("attachment", new String("职工表.xls".getBytes("UTF-8"), "ISO-8859-1"));
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 9:
                                        ...
                                        break;
                                    case 10:
                                        user.setDepartment(cellValue);
                                        break;
                                    case 11:
                                        user.setPosition(cellValue);
                                        break;
                                }
                                break;
                            default: {
