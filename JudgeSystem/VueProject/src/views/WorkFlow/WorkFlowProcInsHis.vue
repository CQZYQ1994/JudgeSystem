    ...
    <div class="process-container">
        <el-card>
            ...
            >
                ...
                <el-table-column label="流程实例名" align="center" width="150">
                    <template slot-scope="scope">
                        <span>{{ scope.row.procInsName }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="流程实例开始时间" align="center" width="250">
                    <template slot-scope="scope">
                        <span>{{ scope.row.procInsStartTime }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="流程实例结束时间" align="center" width="250">
                <template slot-scope="scope">
                    <span>{{ scope.row.procInsEndTime }}</span>
                </template>
            </el-table-column>
                <el-table-column label="流程实例发起人id" align="center" width="150">
                    <template slot-scope="scope">
        ...
        <el-dialog title="流程实例图" :visible.sync="dialogFormVisible2" width="80%">
    ...
    export default {
        ...
        methods: {
            ...
            handleProcImage(row){
                ...
                _this.processInstanceId=row.procInsId;
            },
            goback(){
        ...
        created() {
            const _this=this
            let url='http://localhost:8011/activiti/processIns/procInsHis';
            _this. axios.get(url).then(function(resp) {
                if(resp.status===200){
